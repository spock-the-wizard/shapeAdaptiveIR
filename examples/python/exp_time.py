...
def opt_task(isSweep=True):
    ...
    # Ignore scene file from argument
    ...
    if args.randomInit:
        ...
        sc.param_map[material_key].albedo = Bitmap3fD(np.array([0.9,0.9,0.9]))
        sc.param_map[material_key].sigma_t = Bitmap3fD(np.array([50.0,50.0,50.0]))
        reset_random()
    ...
    def optTask():
        ...
        for i in range(args.n_iters):
            ...
            wandb_log({
                ...
                # "loss/rmse_param_sigT": rmse(param_sig, np.log(params_gt[args.scene]['sigmat'])),
