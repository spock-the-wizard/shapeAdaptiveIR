...
from viewer.datasources import TriangleMesh
...
class ViewerApp(Screen):
    ...
    def __init__(self):
        super(ViewerApp, self).__init__((2480, 2048), "Scattering Viewer", True, nSamples=8, depthBits=32)
        ...
        self.camera.setLookAt(np.array([0, 2,2]), np.array([0, 0, 0]))
